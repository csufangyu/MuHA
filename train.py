    ...
    def train(self):
        ...
        while train_until_step(self.global_step):
            ...
            if not seed_until_step(self.global_step):
                metrics = self.agent.update(self.replay_iter, self.global_step, self.writer)
...
@hydra.main(config_path='cfgs', config_name='muha')
def main(cfg):
    from train_sti import Workspace as W
    root_dir = Path.cwd()
    workspace = W(cfg)
